...
get_complete_author_info(last_name = 'Ackerman',first_name = 'Frank', api_key = "44f055d2666f0d63b928f6d10e2f77d2")
...
test = get("error", res$entries[[1]][2])
if (test == "Result set was empty") {
